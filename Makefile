...
# Project:  Command.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile Command.pro
#############################################################################
...
DISTDIR = /home/gustavo/Projetos/C++/Command/.tmp/Command1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
Makefile: Command.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Command.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile Command.pro
